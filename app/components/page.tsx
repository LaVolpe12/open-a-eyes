...
export default function ComponentsPage() {
  const components = [
    ...
    {
      name: "Raspberry Pi Kamera V2",
      description: "8MP Kamera für Bilderfassung",
      price: "25-30€",
      link: "https://www.raspberrypi.com/products/camera-module-v2/",
    },
    { name: "Kleiner Lautsprecher", description: "Für Audioausgabe", price: "5-10€", link: "#" },
    { name: "Mikrofon", description: "Für Sprachbefehle", price: "8-12€", link: "#" },
    { name: "Akku (3.7V LiPo)", description: "Stromversorgung", price: "10-15€", link: "#" },
    { name: "Micro SD Karte (min. 16GB)", description: "Für Betriebssystem und Software", price: "8-12€", link: "#" },
    { name: "Kleine Schrauben (M2)", description: "Für die Montage", price: "3-5€", link: "#" },
    { name: "Kabel und Stecker", description: "Für die Verbindungen", price: "5-8€", link: "#" },
    { name: "Kleines Display (optional)", description: "Für visuelle Rückmeldungen", price: "15-25€", link: "#" },
  ]
        ...
        <div className="bg-gray-700 rounded-lg shadow-lg p-6">
          ...
          <div className="overflow-x-auto">
            <Table className="border-collapse">
              <TableCaption className="text-gray-400">Komponenten für die Open-A-Eyes KI-Brille</TableCaption>
              <TableHeader>
